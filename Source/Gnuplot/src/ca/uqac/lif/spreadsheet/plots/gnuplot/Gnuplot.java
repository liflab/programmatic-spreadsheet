...
public abstract class Gnuplot implements Plot, ExplanationQueryable
{
	 ...
	 *   rendering
	 */
	public final void toGnuplot(PrintStream out, Spreadsheet table, PlotFormat term, boolean with_caption)
	{
	 ...
	 */
	public static String getTerminalName(PlotFormat t)
	{
	 ...
	 * @return The header
	 */
	protected void printHeader(PrintStream out, PlotFormat term, String comment_line, boolean with_caption)
	{
		out.println("# ----------------------------------------------------------------");
