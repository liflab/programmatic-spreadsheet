 ...
 */
public interface Chart extends ExplanationQueryable
{
	/**
	 ...
	 * @return This plot
	 */
	/*@ non_null @*/ public Chart setTitle(/*@ non_null @*/ String title);
	 ...
	 * @return This plot
	 */
	/*@ non_null @*/ public Chart setCaption(/*@ non_null @*/ Axis a, /*@ non_null @*/ String caption);
	 ...
	 * @return This plot
	 */
	public Chart setLogscale(Axis a);
	 ...
	 */
	public Chart setFormat(ChartFormat f) throws UnsupportedPlotFormatException;
	
	/**
	 * Gets the format to be used to render the plot.
	 * @return The format
	 */
	/*@ pure non_null @*/ public ChartFormat getFormat();
	 ...
	 * in a format that it does not support
	 */
	public Chart render(OutputStream out, Spreadsheet s, ChartFormat f, boolean with_title) throws IOException, IllegalArgumentException, UnsupportedPlotFormatException;
	 ...
	 */
	public Chart set(Object ... objects) throws UnsupportedSettingException, IllegalArgumentException;
	
	/**
	 * Creates a deep copy of the current plot with all its settings.
	 * @return A copy of the plot
	 */
	public Chart duplicate();
}
